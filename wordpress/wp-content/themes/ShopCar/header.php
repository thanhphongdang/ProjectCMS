                        ...
                        <li class="axil-user-area menu-account" style="position:relative;">
                            ...
                            <ul class="account-dropdown">
                                <?php if (is_user_logged_in()) : ?>
                                    ...
                                    <li>
                                        <a href="<?php echo wc_get_endpoint_url('edit-account','',wc_get_page_permalink('myaccount')); ?>">Đổi mật khẩu</a>
                                    </li>

                                    <li class="separator"></li>

                                    <li><a class="text-danger" href="<?php echo wp_logout_url(home_url('/login')); ?>">Đăng xuất</a></li>
